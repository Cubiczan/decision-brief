...
git clone https://github.com/icohangar-ops/decision-brief.git
cd decision-brief
...
| [finance-cockpit](https://github.com/icohangar-ops/finance-cockpit) | CFO financial dashboard (Jira Project Page) |
